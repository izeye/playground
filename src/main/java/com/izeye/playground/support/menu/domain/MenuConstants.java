...
public interface MenuConstants {
	...
	String SUB_MENU_ITEM_KOREAN_LOTTO_NAME = "Korean Lotto";
	String SUB_MENU_ITEM_KOREAN_LOTTO_PATH = SUB_MENU_ITEM_GROUP_PLAYGROUND_ENTERTAINMENT_PATH
			+ "/korean_lotto";

	String API_PATH_KOREAN_LOTTO_GENERATE = SUB_MENU_ITEM_KOREAN_LOTTO_PATH
			+ "/generate/api";
	String API_PATH_KOREAN_LOTTO_HISTORY = SUB_MENU_ITEM_KOREAN_LOTTO_PATH
			+ "/history/api";

	String SUB_MENU_ITEM_GROUP_PLAYGROUND_DEMO_PATH = MENU_ITEM_PLAYGROUND_PATH
			+ "/demo";

	String SUB_MENU_ITEM_WEBCAM_LIVE_NAME = "Webcam Live";
	...
	String SUB_MENU_ITEM_TEXT_2_QR_CODE_NAME = "Text 2 QR Code";
	String SUB_MENU_ITEM_TEXT_2_QR_CODE_PATH = SUB_MENU_ITEM_GROUP_TOOLS_LIFE_PATH
			+ "/text2qrcode";

	String API_PATH_TEXT_2_QR_CODE = SUB_MENU_ITEM_TEXT_2_QR_CODE_PATH + "/api";
