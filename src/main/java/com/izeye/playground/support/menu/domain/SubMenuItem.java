...
public enum SubMenuItem {
	...
	PLAYGROUND_DEMO_FIREBASE_CHAT(SUB_MENU_ITEM_FIREBASE_CHAT_NAME,
			SUB_MENU_ITEM_FIREBASE_CHAT_PATH), //
	PLAYGROUND_DEMO_D3_4_CIRCLES_ILLUSION(
			SUB_MENU_ITEM_D3_4_CIRCLES_ILLUSION_NAME,
			SUB_MENU_ITEM_D3_4_CIRCLES_ILLUSION_PATH), //
	...
	TOOLS_LINGUISTICS_LETTER_FREQUENCY(SUB_MENU_ITEM_LETTER_FREQUENCY_NAME,
			SUB_MENU_ITEM_LETTER_FREQUENCY_PATH), //
