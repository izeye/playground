<script type="text/javascript">
	var generateQRCode = function() {
		...
		var qrCodeURL = "http://" + location.host
				+ "${API_PATH_TEXT_2_QR_CODE_IN_JAVA}?text=" + text
				+ "&size=" + size;
		var img = $('<img />').attr({
			'src' : qrCodeURL
		});
...
<p>
This page provides a QR code of any text and the usage of its API version.
</p>
...
<div class="well">
http://izeye.cafe24.com/tools/life/text2qrcode_in_java/api?text=http://izeye.cafe24.com&amp;size=200
</div>

<b>And the result will be a QR code like this:</b>
<div class="well">
<img src="http://izeye.cafe24.com/tools/life/text2qrcode_in_java/api?text=http://izeye.cafe24.com&size=200">
</div>
