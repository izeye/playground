...
var encode = function () {
	$.get('${API_PATH_URL_ENCODER_AND_DECODER_ENCODE}', {
...
var decode = function () {
	$.get('${API_PATH_URL_ENCODER_AND_DECODER_DECODE}', {
...
<input id="textToEncode" type="text" class="input-xxlarge" /><br/>
...
<input id="textToDecode" type="text" class="input-xxlarge" /><br/>
